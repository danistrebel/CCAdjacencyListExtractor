...
/**
 * Url extractor based on the wordcount example by Steve Salevan <steve.salevan@gmail.com>
 * 
...
public class UrlList {
  ...
  public static class CSVOutputFormat
    ...
    protected static class CSVRecordWriter
        implements RecordWriter<Text, IntWritable> {
      ...
      public synchronized void write(Text key, IntWritable value)
        ...
        csvOutput.writeInt(value.get(), "occurrences");
      }
  ...
  public static void main(String[] args) throws IOException {
    ...
    conf.set("mapred.max.map.failures.percent", "4");
    ...
    conf.setMapperClass(UrlExtractMapper.class);
    conf.setCombinerClass(UrlExtractorReducer.class);
    conf.setReducerClass(UrlExtractorReducer.class);

    // Tells Hadoop mappers and reducers to pull dependent libraries from
    // those bundled into this JAR.
    conf.setJarByClass(UrlList.class);
